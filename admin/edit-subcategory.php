...
$image=$_POST['image'];
$query=mysqli_query($con,"update tblsubcategory set CategoryId='$categoryid',Subcategory='$subcatname',SubCatDescription='$subcatdescription',Image='$image' where SubCategoryId='$subcatid'");
if($query)
{
$msg="Curso editado ";
}
...
<div class="col-sm-12">
<div class="card-box">
<h4 class="m-t-0 header-title"><b>Editar Curso </b></h4>
<hr />
<div class="row">
<div class="col-sm-6">  
<!---Success Message--->  
...
<div class="form-group">
<label class="col-md-2 control-label">Encabezado HTML</label>
<div class="col-md-10">
<textarea class="form-control" rows="3" name="image" required><?php echo ($row['image']);?></textarea>
</div>
</div>
<div class="form-group">
<label class="col-md-2 control-label">Descripci&oacute;n del Curso</label>
<div class="col-md-10">
