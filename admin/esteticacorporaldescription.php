...
if($query)
{
$msg="Landing Page actualizada correctamente ";
}
else{
$error="Something went wrong . Intente de nuevo.";    
} 
...
<html lang="en">
    <head>
        ...
        <title>Landing Page Estética Corporal</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Est&eacute;tica Corporal (Edici&oacute;n de Landing Page)  </h4>
...
<strong>Bien!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
...
?>                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="p-6">
                                    <div class="">
                                        <form name="corporalestetica" method="post">
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Actualizar y Publicar</button>
