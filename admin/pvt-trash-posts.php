...
$query=mysqli_query($con,"delete from  pvttblposts  where id='$id'");
...
<td>
<a href="pvt-trash-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=restore" onclick="return confirm('Do you really want to restore ?')"> <i class="ion-arrow-return-right" title="Restaurar este post"></i></a>
&nbsp;
<a href="pvt-trash-posts.php?presid=<?php echo htmlentities($row['postid']);?>&&action=perdel" onclick="return confirm('Borrar permanentemente?')"><i class="fa fa-trash-o" style="color: #f05050" title="Borrar permanentemente"></i></a> 
</td>
</tr>
<?php } }?>                                               
</tbody>
