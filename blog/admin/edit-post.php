...
$query=mysqli_query($con,"update blogtblposts set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
if($query)
{
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select blogtblposts.id as postid,blogtblposts.PostImage,blogtblposts.PostTitle as title,blogtblposts.PostDetails,blogtblcategory.CategoryName as category,blogtblcategory.id as catid,blogtblsubcategory.SubCategoryId as subcatid,blogtblsubcategory.Subcategory as subcategory from blogtblposts left join blogtblcategory on blogtblcategory.id=blogtblposts.CategoryId left join blogtblsubcategory on blogtblsubcategory.SubCategoryId=blogtblposts.SubCategoryId where blogtblposts.id='$postid' and blogtblposts.Is_Active=1 ");
