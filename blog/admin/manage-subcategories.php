...
{
$id=intval($_GET['scid']);
$query=mysqli_query($con,"update  blogtblsubcategory set Is_Active='0' where SubCategoryId='$id'");
$msg="Categoría Borrada ";
}
if($_GET['resid'])
{
$id=intval($_GET['resid']);
$query=mysqli_query($con,"update  blogtblsubcategory set Is_Active='1' where SubCategoryId='$id'");
$msg="Categoría restaurada satisfactoriamente";
}
if($_GET['action']=='perdel' && $_GET['scid'])
{
$id=intval($_GET['scid']);
$query=mysqli_query($con,"delete from   blogtblsubcategory  where SubCategoryId='$id'");
$delmsg="Categoría borrada permanentemente";
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
<title>Administrar Sub categor&iacute;as</title>
...
<h4 class="page-title">Administrar Sub Categor&iacute;as</h4>
...
<li class="active">
Administrar Sub Categor&iacute;a
</li>
</ol>
...
<tbody>
<?php 
$query=mysqli_query($con,"Select blogtblcategory.CategoryName as catname,blogtblsubcategory.Subcategory as subcatname,blogtblsubcategory.SubCatDescription as SubCatDescription,blogtblsubcategory.PostingDate as subcatpostingdate,blogtblsubcategory.UpdationDate as subcatupdationdate,blogtblsubcategory.SubCategoryId as subcatid from blogtblsubcategory join blogtblcategory on blogtblsubcategory.CategoryId=blogtblcategory.id where blogtblsubcategory.Is_Active=1");
$cnt=1;
...
<div class="demo-box m-t-20">
<div class="m-b-30">
<h4><i class="fa fa-trash-o" ></i> Papelera de Sub Categor&iacute;as</h4>
</div>
<div class="table-responsive">
...
<tbody>
<?php 
$query=mysqli_query($con,"Select blogtblcategory.CategoryName as catname,blogtblsubcategory.Subcategory as subcatname,blogtblsubcategory.SubCatDescription as SubCatDescription,blogtblsubcategory.PostingDate as subcatpostingdate,blogtblsubcategory.UpdationDate as subcatupdationdate,blogtblsubcategory.SubCategoryId as subcatid from blogtblsubcategory join blogtblcategory on blogtblsubcategory.CategoryId=blogtblcategory.id where blogtblsubcategory.Is_Active=0");
$cnt=1;
$rowcount=mysqli_num_rows($query);
if($rowcount==0)
{
