...
$query=mysqli_query($con,"update blogtblsubcategory set CategoryId='$categoryid',Subcategory='$subcatname',SubCatDescription='$subcatdescription' where SubCategoryId='$subcatid'");
if($query)
{
...
<?php 
$subcatid=intval($_GET['scid']);
$query=mysqli_query($con,"Select blogtblcategory.CategoryName as catname,blogtblcategory.id as catid,blogtblsubcategory.Subcategory as subcatname,blogtblsubcategory.SubCatDescription as SubCatDescription,blogtblsubcategory.PostingDate as subcatpostingdate,blogtblsubcategory.UpdationDate as subcatupdationdate,blogtblsubcategory.SubCategoryId as subcatid from blogtblsubcategory join blogtblcategory on blogtblsubcategory.CategoryId=blogtblcategory.id where blogtblsubcategory.Is_Active=1 and  SubCategoryId='$subcatid'");
$cnt=1;
...
<?php
$ret=mysqli_query($con,"select id,CategoryName from  blogtblcategory where Is_Active=1");
