...
$sql=mysqli_query($con,"SELECT AdminPassword FROM  blogtbladmin where AdminUserName='$adminid' || AdminEmailId='$adminid'");
...
$con=mysqli_query($con,"update blogtbladmin set AdminPassword='$newhashedpass', updationDate='$currentTime' where AdminUserName='$adminid'");
...
<div class="col-sm-12">
<div class="card-box">
<h4 class="m-t-0 header-title"><b>Cambiar Contrase&ntilde;a </b></h4>
<hr />
<div class="row">
<div class="col-sm-6">  
<!---Success Message--->  
