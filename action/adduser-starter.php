<?php	
	...
	if (empty($_POST['fullname'])) {
		...
		if ($count>0){
			...
			$sql = "insert into user (status,fullname,email,is_admin,password,phone,country,image,created_at) ";
			$sql .= "value (\"$status\",\"$fullname\",\"$email\",\"$is_admin\",\"$password\",\"$phone\",\"$country\",\"$default_profile\",$created_at)";
