...
<p>
La Est&eacute;tica tambi&eacute;n aporta salud y bienestar, como queda patente en tratamientos antiestr&eacute;s y drenaje linfático aplicados en la zona del rostro
</p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle" style="color: #0078AF">Curso de Fundamentos de Estética Facial</h5>
      ...
      <div class="modal-body">
       ...
       <h6>Anatomía, Fisiología e Histología de la Piel</h6> 
<ul>
<li> Descripción y Objetivos del curso </li>
<li> Dermatología Facial- Epidermis </li>
<li> Dermatología Facial - Dermis  </li>
<li> Dermatología Facial - Hipodermis  </li>
<li> Fundamentos de Morfofisiología Facial Huesos  </li>
<li> Fundamentos de Morfofisiología Facial Músculos  </li>
</ul>
 		<h6>Fundamentos y Aplicaciones del Análisis Facial </h6>
<ul>
<li> Análisis Estético y Analítico del Paciente </li>
<li> Biotipos Cutáneos </li>
<li> Lesiones Cutáneas </li>
<li> Bioseguridad y Ambientación </li>
<li> Evidencia Práctica No.1 Anatomía y Aplicaciones del Análisis Facial  </li>
</ul>
<h6>Ténicas Necesarias para Procedimientos Faciales</h6>
<ul>
<li> Maniobras Generales </li>
<li> Teoría de Exfoliación  </li>
<li> Practica de Exfoliación </li>
<li> Teoría Protocolo de Limpieza Básica </li>
<li> Práctica de Protocolo de Limpieza Básica </li>
<li> Bioseguridad  </li>
<li> Evidencia Práctica No 2 Maniobras Generales Y Protocolo de Exfoliación y limpieza facial  </li>
<li> Evaluación Final Teórica  </li>
<li> Cierre de Módulo </li>
 </ul>
      </div>
...
<div class="modal fade" id="exampleModalLong2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
<h6>Aplicaciones de Procedimientos faciales con aparatología Inicial </h6>

 <ul>Introducción
<li> Manejo de Vapor Ozono </li>
<li> Manejo de Alta Frecuencia </li>
<li> Materiales Requeridos </li>
<li> Teoría de Protocolo de Limpieza Facial Profunda </li>
<li> Protocolo de Limpieza Facial Profunda 2  </li>
<li> Evidencia Práctica No. 3 Protocolos de Limpieza Facial </li>
 </ul>

<h6>Regeneración Cutánea con Protocolos de Hidratación </h6>
<ul>
<li> Introducción </li>
<li> Nutrición e Hidratación de la Piel 1  </li>
<li> Nutrición e Hidratación de la Piel 2 </li>
<li> Nutrición e Hidratación de la Piel 3 </li>
<li> Evidencia Práctica No. 4 Nutrición e Hidratación de la Piel  </li>
</ul>
<h6>Restauración e Higiene Facial </h6>
<ul>
<li> Higiene Profunda e Hidratación  </li>
...
<li> Evidencia Teórica </li>
<li> Evidencia Práctica No. 5 Restauración e Higiene Facial  </li>
<li> Cierre de Módulo y Despedida  </li>
</ul>
...
<ul>
 ...
 <li> Tratamiento para Acné 1  </li>
 <li> Tratamiento para Acné 2 </li>
 <li> Tratamiento para Acné Protocolo 1  </li>
 <li> Tratamiento para Acné Protocolo 2 </li>
 <li> Evidencia Práctica No. 6 Acné </li>
</ul>
...
<li>  Evidencia Práctica No. 7 Envejecimiento Facial  </li>
</ul>
<h6>Procedimientos Estéticos Especializados a Nivel Facial </h6>
<ul>
<li>  Introducción a los Procedimientos Estéticos Especializados a Nivel Facial </li>
<li>  Hidratación Facial con Velos de Colágeno </li>
<li>  Protocolo de Hidratación Facial con Velos de Colágeno </li>
<li>  Mascarillas según Tipo de Piel </li>
 <li> Lifting Facial con Crioyeso Teoría </li>
 <li> Lifting Facial con Crioyeso Práctica 1 </li>
 <li> Lifting Facial con Crioyeso Práctica 2 </li>
 <li> Evidencia Práctica  </li>
<li>  Evidencia Teórica  </li>
<li>  Cierre de Módulo </li>
</ul>
      </div>
...
<div class="modal fade" id="exampleModalLong4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle" style="color: #0078AF">Procedimientos Complementarios con Aparatología Facial</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
<h6>Aparatología Especializada Peeling Ultrasónico </h6>
<ul>
<li> Peeling Ultrasónico</li> 
<li> Peeling Ultrasónico Práctica 1</li>
<li> Peeling Ultrasónico Práctica 2</li>
</ul>
<h6>Especialidades de la RadioFrecuencia y Electroporador</h6>
<ul>
<li> Radiofrecuencia Teoría</li>
<li> Radiofrecuencia Práctica </li>
<li> Eletroporación </li>
<li> Electroporación Practica</li>
</ul>
<h6>Peeling mecánico con microdermoabrasión </h6>
<ul>
<li>Microdermoabrasión</li>
<li> Manejo de la Microdermoabrasión Práctica 1 </li>
<li> Manejo de la Microdermoabrasión Práctica 2</li>
<li> Evidencia Práctica </li>
<li> Evidencia Teórica </li>
</ul>
...
<div class="modal fade" id="exampleModalLong5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle" style="color: #0078AF">Tratamientos Estéticos Manuales en Cara y Cuello</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
<h6>Drenaje Linfático</h6>
<ul>
<li> Sistema Linfático  </li>
<li> Protocolo de Drenaje Linfático Parte 1 </li>
<li> Protocolo de Drenaje Linfático Parte 2 </li>
<li> Protocolo de Drenaje Linfático Parte 3 </li>
</ul>
<h6>Tratamiento Anti Estrés </h6>
<ul>
<li> Masaje Anti-Estrés Teoría </li>
<li> Protocolo Masaje Anti-Estrés Parte 1 </li>
<li> Protocolo Masaje Anti-Estrés Parte 2 </li>
<li> Cierre de Módulo </li>
<li> Evidencia Práctica  </li>
<li> Evidencia Práctica  </li>
</ul>
