...
<tbody>
<?php 
$query=mysqli_query($con,"Select tblcomments.id,  tblcomments.name,tblcomments.email,tblcomments.postingDate,tblcomments.comment,pvttblposts.id as postid,pvttblposts.PostTitle from  tblcomments join pvttblposts on pvttblposts.id=tblcomments.postId where tblcomments.status=1");
$cnt=1;
