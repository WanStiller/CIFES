...
<td><a href="pvt-edit-post.php?pid=<?php echo htmlentities($row['postid']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
&nbsp;<a href="pvt-manage-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=del" onclick="return confirm('Está seguro que desea suprimir este elemento?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
</tr>
<?php } }?>
</tbody>
</table>
