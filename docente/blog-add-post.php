...
$status=1;
$query=mysqli_query($con,"insert into blogtblposts(PostTitle,CategoryId,SubCategoryId,PostDetails,PostUrl,Is_Active,PostImage) values('$posttitle','$catid','$subcatid','$postdetails','$url','$status','$imgnewfile')");
if($query)
{
...
<label for="exampleInputEmail1">T&iacute;tulo del Art&iacute;culo en el Blog</label>
