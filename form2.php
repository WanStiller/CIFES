...
<input type="hidden" class="form-control" name="mensaje" id="mensaje" value="Evidencia Práctica No 2 Maniobras Generales Y Protocolo de Exfoliación y limpieza facial" required>
</div>
<div class="form-group">
